...
/** Componente encargado de gestionar tipo mantenimiento */
@Component({
  // tslint:disable-next-line: component-selector
  selector: 'sigma-administracion-tipomantenimiento-admin',
  templateUrl: './tipomantenimiento-admin.component.html'
})
export class TipomantenimientoAdminComponent implements OnInit {
