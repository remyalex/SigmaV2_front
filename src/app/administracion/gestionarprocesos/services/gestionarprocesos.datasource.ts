 ...
 **/
export class GestionarProcesosDatasource implements DataSource<GestionarProcesosModel> {
 /** Constantes a usar en el componente */
  constants = CONST_ADMINISTRACION_GESTIONARPROCESOS;
  private gestionarProcesosSubject = new BehaviorSubject<GestionarProcesosModel[]>([]);
  ...
  public gestionarProcesosData: any;
  ...
  */
  constructor (private servicio: GestionarprocesosService) { }
   ...
   */
  connect(collectionViewer: CollectionViewer): Observable<GestionarProcesosModel[]> {
    return this.gestionarProcesosSubject.asObservable();
  }
  ...
  disconnect(collectionViewer: CollectionViewer): void {
    this.gestionarProcesosSubject.complete();
 ...
 /**
   ...
   */
  loadData(criteria: GestionarProcesosCriteria): void {
    ...
    this.petitionList = this.servicio.search(criteria)
      .subscribe(
        async (data: any) => {
          this.gestionarProcesosData = data;
          this.gestionarProcesosSubject.next(data.content);
        ...
        error => {
          this.gestionarProcesosSubject.next([]);
