 ...
 **/
export class MensajeDatasource implements DataSource<Mensaje> {
  ...
  */
   ...
   */
  connect(collectionViewer: CollectionViewer): Observable<Mensaje[]> {
 ...
 /**
   ...
   */
  loadData(criteria: MensajeCriteria): void {
    ...
    this.petitionList = this.servicio.search(criteria)
      .subscribe(async (data: any) => {
        this.mensajeSubject.next(data.content);
