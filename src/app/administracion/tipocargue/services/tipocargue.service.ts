...
export class TipocargueService {
  ...
  */
    ...
    this.resourceUrl = appSettings.settings.hostApi + this.constants.path_administracion_tipocargue;
   }
   ...
   */
  search(criteria: TipocargueCriteria): Observable<CollectionResponse<Tipocargue>> {
    return this.http.get<CollectionResponse<Tipocargue>>(this.resourceUrl + 'search?' + criteria.getUrlParameters());
  }
   ...
   */
  list (): Observable<Tipocargue[]> {
    return this.http.get<Tipocargue[]>(this.resourceUrl);
  }
   ...
   */
  create (tipocargue: Tipocargue): Observable<Tipocargue> {
    return this.http.post<Tipocargue>(this.resourceUrl, tipocargue, httpOptions );
  }
  ...
  */
  update (tipocargue: Tipocargue): Observable<Tipocargue> {
    return this.http.put<Tipocargue>(this.resourceUrl, tipocargue, httpOptions );
  }
   ...
   * registro que se va a actualizar
   */
  detail (tipocargueId: number): Observable<Tipocargue> {
    return this.http.get<Tipocargue>(this.resourceUrl + tipocargueId);
  }
  ...
  * registro que se va a actualizar
  */
  delete (tipocargueId: number): Observable<Tipocargue> {
    return this.http.delete<Tipocargue>(this.resourceUrl + tipocargueId);
  }
