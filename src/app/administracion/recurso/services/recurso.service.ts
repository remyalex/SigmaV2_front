...
export class RecursoService {
  ...
  public positionTab = new BehaviorSubject({});
  public positionTab$ = this.positionTab.asObservable();
  ...
  */
    ...
    this.resourceUrl = appSettings.settings.hostApi + this.constants.path_administracion_recurso;
   }
   ...
   */
  search(criteria: RecursoCriteria): Observable<CollectionResponse<Recurso>> {
    return this.http.get<CollectionResponse<Recurso>>(this.resourceUrl + '/search?' + criteria.getUrlParameters());
  }
  ...
  list (): Observable<Recurso[]> {
    return this.http.get<Recurso[]>(this.resourceUrl);
  }
   ...
   */
  create (equipodisponibilidad: Recurso): Observable<Recurso> {
    return this.http.post<Recurso>(this.resourceUrl, equipodisponibilidad, httpOptions );
  }
  ...
  */
  update (equipodisponibilidad: Recurso): Observable<Recurso> {
    return this.http.put<Recurso>(this.resourceUrl, equipodisponibilidad, httpOptions );
  }
   ...
   * registro que se va a actualizar
   */
  detail (equipodisponibilidadId: number): Observable<Recurso> {
    return this.http.get<Recurso>(this.resourceUrl + '/' + equipodisponibilidadId);
  }
  ...
  * registro que se va a actualizar
  */
  delete (equipodisponibilidadId: number): Observable<Recurso> {
    return this.http.delete<Recurso>(this.resourceUrl + '/' + equipodisponibilidadId);
  }
  
  changeSelectedTab(position: number) {
    this.positionTab.next(position);
  }
