...
/** Componente encargado de gestionar la eliminación de un barrio */
@Component({
  selector: 'app-barrio-delete',
  templateUrl: './barrio-delete.component.html'
})
export class BarrioDeleteComponent implements OnInit {
  ...
  */
  constructor(
    ...
    private dialogRef: MatDialogRef<BarrioDeleteComponent>,
  ...
  save() {
    ...
    this.servicio.delete(this.barrio.id).subscribe(
      data => {
