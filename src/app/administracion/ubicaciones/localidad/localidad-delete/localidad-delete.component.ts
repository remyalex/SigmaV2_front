...
/** Componente encargado de gestionar la eliminación de una localidad */
@Component({
...
export class LocalidadDeleteComponent implements OnInit {
  ...
  */
  constructor(
    ...
    private dialogRef: MatDialogRef<LocalidadDeleteComponent>,
  ...
  save() {
    ...
    this.servicio.delete(this.localidad.id).subscribe(
      data => {
