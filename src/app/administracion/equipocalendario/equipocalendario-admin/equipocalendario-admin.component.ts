...
@Component({
  ...
  selector: 'sigma-administracion-equipocalendario-admin',
  templateUrl: './equipocalendario-admin.component.html'
})
export class EquipocalendarioAdminComponent implements OnInit {
