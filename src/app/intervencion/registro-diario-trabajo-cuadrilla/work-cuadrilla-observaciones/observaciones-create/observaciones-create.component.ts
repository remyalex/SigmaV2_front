...
@Component({
  selector: 'app-observaciones-create',
  templateUrl: './observaciones-create.component.html'
})
export class ObservacionesCreateComponent implements OnInit {
  ...
  */
  constructor(private formBuilder: FormBuilder, private snackBar: MatSnackBar, private dialogRef: MatDialogRef<ObservacionesCreateComponent>, private serviceCuadrillaGeneral: CuadrillaGeneralService, private utilitiesServices: UtilitiesService, private commonService: CommonService, private dialog: MatDialog) {
