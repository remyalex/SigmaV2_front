...
export class EquipoCreateComponent implements OnInit {
 ...
 /** Constantes a usar en el componente */
  ...
  constructor(@Inject(MAT_DIALOG_DATA) data: any, private formBuilder: FormBuilder, private snackBar: MatSnackBar, private dialogRef: MatDialogRef<EquipoCreateComponent>, private serviceCuadrillaGeneral: CuadrillaGeneralService, private utilitiesServices: UtilitiesService, private commonService: CommonService, private dialog: MatDialog) {
  ...
  fieldDisabled() {
    ...
    this.CuadrillaEquipoModel.horometroInicial = null;
    this.form.get('horometroFinal').disable();
    this.CuadrillaEquipoModel.horometroFinal = null;
    this.form.get('horasTrabajadas').disable(); this.CuadrillaEquipoModel.horasTrabajadas = null;
    this.form.get('standBy').disable();
    this.CuadrillaEquipoModel.standBy = null;
    this.form.get('noVale').disable();
    this.CuadrillaEquipoModel.vale = null;
    this.form.get('numeroViaje').disable(); this.CuadrillaEquipoModel.numeroViaje = null;
    this.form.get('dia').disable();
    this.CuadrillaEquipoModel.dia = null;
  }
