...
@Component({
  ...
  templateUrl: './petreos-rap-edit.component.html'
})
export class PetreosRapEditComponent implements OnInit, DoCheck {
 ...
 /** Constantes a usar en el componente */
  ...
  CuadrillaPetreosModel: CuadrillaPetreosModel = new CuadrillaPetreosModel();
  clone: CuadrillaPetreosModel;
  ...
  constructor(@Inject(MAT_DIALOG_DATA) data: any, private formBuilder: FormBuilder, private snackBar: MatSnackBar, private dialogRef: MatDialogRef<PetreosRapEditComponent>, private serviceCuadrillaGeneral: CuadrillaGeneralService, private utilitiesServices: UtilitiesService, private commonService: CommonService, private dialog: MatDialog) {
    this.mantenimiento = data.mantenimiento;
    this.volumenesPorMaterial = data.volumenesPorMaterial;
    this.CuadrillaPetreosModel = JSON.parse(JSON.stringify(data.petreo));
  ...
  ngOnInit() {
    ...
    this.clone = JSON.parse(JSON.stringify(this.CuadrillaPetreosModel));
    ...
    this.validation();
    // tslint:disable-next-line: max-line-length
    this.CuadrillaPetreosModel.claseMaterial = this.CuadrillaPetreosModel.claseMaterial === null ? undefined : this.CuadrillaPetreosModel.claseMaterial;
    // tslint:disable-next-line: max-line-length
    this.CuadrillaPetreosModel.origenMezcla = this.CuadrillaPetreosModel.origenMezcla === null ? undefined : this.CuadrillaPetreosModel.origenMezcla;
    // tslint:disable-next-line: max-line-length
    this.CuadrillaPetreosModel.valeEntrada = this.CuadrillaPetreosModel.valeEntrada === null ? undefined : this.CuadrillaPetreosModel.valeEntrada;
    // tslint:disable-next-line: max-line-length
    this.CuadrillaPetreosModel.valeSalida = this.CuadrillaPetreosModel.valeSalida === null ? undefined : this.CuadrillaPetreosModel.valeSalida;
    // tslint:disable-next-line: max-line-length
    this.CuadrillaPetreosModel.placa = this.CuadrillaPetreosModel.placa === null ? undefined : this.CuadrillaPetreosModel.placa;
    // tslint:disable-next-line: max-line-length
    this.CuadrillaPetreosModel.horaEntrada = this.CuadrillaPetreosModel.horaEntrada === null ? undefined : this.CuadrillaPetreosModel.horaEntrada;
    // tslint:disable-next-line: max-line-length
    this.CuadrillaPetreosModel.horaEntrada = this.CuadrillaPetreosModel.horaEntrada === null ? undefined : this.CuadrillaPetreosModel.horaEntrada;
    // tslint:disable-next-line: max-line-length
    this.CuadrillaPetreosModel.volumenEntrada = this.CuadrillaPetreosModel.volumenEntrada === null ? undefined : this.CuadrillaPetreosModel.volumenEntrada;
    // tslint:disable-next-line: max-line-length
    this.CuadrillaPetreosModel.volumenSalida = this.CuadrillaPetreosModel.volumenSalida === null ? undefined : this.CuadrillaPetreosModel.volumenSalida;
    // tslint:disable-next-line: max-line-length
    this.CuadrillaPetreosModel.volumenUtilizado = this.CuadrillaPetreosModel.volumenUtilizado === null ? undefined : this.CuadrillaPetreosModel.volumenUtilizado;
    // tslint:disable-next-line: max-line-length
    this.CuadrillaPetreosModel.volumenAcopio = this.CuadrillaPetreosModel.volumenAcopio === null ? undefined : this.CuadrillaPetreosModel.volumenAcopio;
    // tslint:disable-next-line: max-line-length
    this.CuadrillaPetreosModel.destino = this.CuadrillaPetreosModel.destino === null ? undefined : this.CuadrillaPetreosModel.destino;
    // tslint:disable-next-line: max-line-length
    this.CuadrillaPetreosModel.archivosPetreos = this.CuadrillaPetreosModel.archivosPetreos === null ? undefined : this.CuadrillaPetreosModel.archivosPetreos;
    this.calcularVolumenAcopio();
    this.extractArchivosBySolicitud();
  }

  extractArchivosBySolicitud() {
    if (this.CuadrillaPetreosModel.archivosPetreos) {
      this.archivosMaterial = [];
      for (const materialArchivo of this.CuadrillaPetreosModel.archivosPetreos) {
  ...
  onBack() {
    ...
    dialogRef.beforeClosed().subscribe(val => {
      if (val === 1) {
        this.CuadrillaPetreosModel = this.clone;
        this.close();
      }
    });
  }
