...
@Component({
  ...
  selector: 'sigma-mantenimientos-seleccionados',
  templateUrl: './mantenimientos-seleccionados.component.html'
})
export class MantenimientosSeleccionadosComponent implements OnInit {
  ...
  */
  ...
  seleccionMantenimiento(mantenimiento: WorkflowMantenimientoModel, event: any) {
    if (event.checked) {
      ...
      mantenimiento.intervenciones[0].residenteSocial = null;
