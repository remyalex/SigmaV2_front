...
@Component({
  selector: 'sigma-gestion-social-adelantada-edit',
  templateUrl: './gestion-social-adelantada-edit.component.html'
})
export class GestionSocialAdelantadaEditComponent extends BaseComponent implements OnInit {
 ...
 /** Constantes a usar en el componente */
  ...
  processing = true;
  pk = '';
  gestionSocial: GestionSocialAdelantadaModel;
  ultimaActa: Acta;
  frenteObra = '';
  ...
  constructor(
    ...
    this.gestionSocial = this.constants.gObject;
  ...
  ngOnInit() {
    ...
    this.mantenimiento =  this.gestionSocial.mantenimiento;
  ...
  save() {
    this.servicioGestion.update(this.gestionSocial).subscribe(
      data => {
