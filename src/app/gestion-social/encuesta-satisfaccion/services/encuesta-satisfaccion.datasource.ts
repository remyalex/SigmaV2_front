 ...
 **/
export class EncuestaSatisfaccionDatasource implements DataSource<EncuestaSatisfaccion>{
 /** Constantes a usar en el componente */
  constants = CONST_ENCUESTA_SATISFACCION;
  private encuestaSubject = new BehaviorSubject<EncuestaSatisfaccion[]>([]);
  ...
  */
  constructor (private servicio: EncuestaSatisfaccionService) { }
   ...
   */
  connect(collectionViewer: CollectionViewer): Observable<EncuestaSatisfaccion[]> {
 ...
 /**
   ...
   */
  loadData(criteria: EncuestaSatisfaccionCriteria): void {
