...
/** Componente encargado de gestionar el proceso de registro de resultados de apiques*/
@Component({
  selector: 'app-registrar-resultado-apique',
  templateUrl: './registrar-resultado-apique.component.html'
})
export class RegistrarResultadoApiqueComponent extends BaseComponent implements OnInit, AfterViewChecked, OnDestroy, FormComponent {
  ...
  /** Variable usada para identificar los campos por
   * los cuales se realizará el ordenamiento de la grilla */
  defaultSortGrid: DefaultSortGrid = {
    sortBy: 'prioritarios', sortOrder: 'asc'
  };
  ...
  */
  ...
  ngOnInit() {
    ...
    this.commonService.getCondicionByNombre('PK con apiques pendientes de resultados').subscribe(_condicion => {
   ...
   * solicitar los resultados de apique
   *
