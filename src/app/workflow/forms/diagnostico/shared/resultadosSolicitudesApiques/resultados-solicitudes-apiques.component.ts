 ...
 *  enviados a estudio de apiques */
@Component({
  selector: 'app-resultados-solicitudes-apiques',
  templateUrl: './resultados-solicitudes-apiques.component.html'
})
export class ResultadosSolicitudesApiquesComponent implements OnInit {
  ...
  * de la información */
   ...
   */
  constructor(
    private dialogRef: MatDialogRef<ResultadosSolicitudesApiquesComponent>,
  ...
  ngOnInit() {
    ...
    this.archivosDatasource = new MatTableDataSource<ArchivoMantenimientoModel>(this.mantenimiento.resultadosSolicitudesApiques);
  ...
  save() {
    ...
    this.data.usuarioAsignado = this.mantenimiento.responsable;
  ...
  addArchivo(): void {
    ...
    dialogConfig.autoFocus = true;
    dialogConfig.data = {
      'actividadCargaArchivos': 'registrar-resultado-apique',
  ...
  removeArchivo(index: number) {
    this.mantenimiento.resultadosSolicitudesApiques.splice(index, 1);
    this.archivosDatasource.data = this.mantenimiento.resultadosSolicitudesApiques;
    this.form.get('archivos')
      .setValue(this.mantenimiento.resultadosSolicitudesApiques);
  }
