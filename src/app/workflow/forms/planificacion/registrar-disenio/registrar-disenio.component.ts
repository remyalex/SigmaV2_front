...
@Component({
  selector: 'app-registrar-disenio',
  templateUrl: './registrar-disenio.component.html'
})
export class RegistrarDisenioComponent extends BaseComponent implements OnInit, AfterViewChecked, OnDestroy, FormComponent {
