...
@Component({
  selector: 'app-cargar-estudio-disenio',
  templateUrl: './cargar-estudio-disenio.component.html'
})
export class CargarEstudioDisenioComponent extends BaseComponent implements OnInit, AfterViewChecked, OnDestroy, FormComponent {
