...
@Component({
  selector: 'app-revisar-pre-disenio',
  templateUrl: './revisar-pre-disenio.component.html'
})
export class RevisarPreDisenioComponent extends BaseComponent implements OnInit, AfterViewChecked, OnDestroy, FormComponent {
