...
@Component({
  selector: 'app-registrar-pre-disenio',
  templateUrl: './registrar-pre-disenio.component.html'
})
export class RegistrarPreDisenioComponent extends BaseComponent implements OnInit, AfterViewChecked, OnDestroy, FormComponent {
  ...
  ngOnInit() {
    ...
    this.commonService.getCondicionByNombre('PK_REGISTRAR_PREDISENIO').subscribe(_condicion => {
