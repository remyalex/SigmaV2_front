...
@Component({
  selector: 'app-actualizar-disenio',
  templateUrl: './actualizar-disenio.component.html'
})
export class ActualizarDisenioComponent extends BaseComponent implements OnInit, AfterViewChecked, OnDestroy, FormComponent {
