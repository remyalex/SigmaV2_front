...
@Component({
  ...
  templateUrl: './ver-visita-pre-disenio.component.html'
})
export class VerVisitaPreDisenioComponent extends BaseComponent implements OnInit, AfterViewChecked, OnDestroy, FormComponent {
  ...
  ngOnInit() {
    ...
    this.commonService.getCondicionByNombre('PK_REVISAR_PREDISENIO').subscribe(_condicion => {
