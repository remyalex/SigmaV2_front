...
@Component({
  selector: 'app-actualizar-pre-disenio',
  templateUrl: './actualizar-pre-disenio.component.html'
})
export class ActualizarPreDisenioComponent extends BaseComponent implements OnInit, AfterViewChecked, OnDestroy, FormComponent {
