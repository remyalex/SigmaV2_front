...
@Component({
  selector: 'app-editar-resultados-aforos',
  templateUrl: './editar-resultados-aforos.component.html'
})
export class EditarResultadosAforosComponent extends BaseComponent implements OnInit, AfterViewChecked, OnDestroy, FormComponent {
