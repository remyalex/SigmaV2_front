...
@Component({
  ...
  templateUrl: './create-visita-pre-disenio.component.html'
})
export class CreateVisitaPreDisenioComponent extends BaseComponent implements OnInit, AfterViewChecked, OnDestroy, FormComponent {
  ...
  async executeTransition(): Promise<void> {
    ...
    await this.mapService.connectToGrid(this.grids.first);
    this.mapService.getVisor().visible = true;
    this.mapService.getVisor().activarSeleccion = true;
  }
