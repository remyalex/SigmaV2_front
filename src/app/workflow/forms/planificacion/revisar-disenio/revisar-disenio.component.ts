...
@Component({
  selector: 'app-revisar-disenio',
  templateUrl: './revisar-disenio.component.html'
})
export class RevisarDisenioComponent extends BaseComponent implements OnInit, AfterViewChecked, OnDestroy, FormComponent {
