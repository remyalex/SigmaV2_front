...
@Component({
  ...
  selector: 'sigma-consolidado-diario-trabajo',
  templateUrl: './consolidado-diario-trabajo.component.html'
})
export class ConsolidadoDiarioTrabajoComponent extends BaseComponent implements OnInit, AfterViewChecked, OnDestroy, FormComponent {
  ...
  acciones: GridAccion[] = [
    { nombre: 'accionSimple', label: 'Accion', icono: 'add', color: 'primary' },
  ];
