...
@Component({
  ...
  selector: 'sigma-programar-personal-planta',
  templateUrl: './programar-personal-planta.component.html'
})
export class ProgramarPersonalPlantaComponent extends BaseComponent implements OnInit, AfterViewChecked, OnDestroy, FormComponent {
