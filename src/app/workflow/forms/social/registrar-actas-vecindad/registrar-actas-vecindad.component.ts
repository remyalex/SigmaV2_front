...
import { CONST_ACTAS_VECINDAD } from '../../../../gestion-social/actas-vecindad/actas-vecindad.constant';
import { ActaArchivos, Acta } from '../../../../gestion-social/actas-vecindad/models/actas-vecindad.model';

@Component({
  selector: 'app-registrar-actas-vecindad',
  templateUrl: './registrar-actas-vecindad.component.html'
})
export class RegistrarActasVecindadComponent extends BaseComponent implements OnInit, AfterViewChecked, FormComponent {
