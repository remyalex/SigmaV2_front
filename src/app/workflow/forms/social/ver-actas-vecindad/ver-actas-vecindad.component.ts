...
@Component({
  selector: 'app-ver-actas-vecindad',
  templateUrl: './ver-actas-vecindad.component.html'
})
export class VerActasVecindadComponent extends BaseComponent implements OnInit, AfterViewChecked, OnDestroy, FormComponent {
