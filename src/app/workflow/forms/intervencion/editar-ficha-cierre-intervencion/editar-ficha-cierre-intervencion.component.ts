...
@Component({
  selector: 'app-editar-ficha-cierre-intervencion',
  templateUrl: './editar-ficha-cierre-intervencion.component.html'
})
export class EditarFichaCierreIntervencionComponent extends BaseComponent implements OnInit, AfterViewChecked, OnDestroy, FormComponent {
