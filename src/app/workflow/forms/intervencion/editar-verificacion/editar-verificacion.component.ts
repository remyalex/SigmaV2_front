...
@Component({
  selector: 'app-editar-verificacion',
  templateUrl: './editar-verificacion.component.html'
})
export class EditarVerificacionComponent extends BaseComponent implements OnInit, AfterViewChecked, OnDestroy, FormComponent {
