...
@Component({
  selector: 'app-ver-fuentes-informacion',
  templateUrl: './ver-fuentes-informacion.component.html'
})
export class VerFuentesInformacionComponent extends BaseComponent implements OnInit, AfterViewChecked, OnDestroy, FormComponent {
