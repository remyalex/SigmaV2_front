...
@Component({
  selector: 'sigma-form-webcam',
  templateUrl: './sigma-form-webcam.component.html'
})
export class SigmaFormWebcamComponent implements OnInit {

  @Input('tomarFotoBtn') tomarFotoBtn: boolean = false;
