 ...
 **/
export class SolicitudEnsayosDatasource implements DataSource<SolicitudEnsayos> {
  ...
  public ensayosData$ = this.ensayosSubject.asObservable();
  ...
  */
  constructor(private servicio: SolicitudEnsayosService) { }
  ...
  loadDataExcel(criteria: SolicitudEnsayosCriteria): void {
    this.loadingSubject.next(true);
    if (this.petitionList) {
      this.petitionList.unsubscribe();
    }
