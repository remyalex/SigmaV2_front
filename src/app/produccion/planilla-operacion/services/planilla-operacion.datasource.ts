 ...
 **/
export class PlanillaOperacionDatasource implements DataSource<PlanillaOperacion> {
 /** Constantes a usar en el componente */
  constants = CONST_REGISTRAR_PLANILLA_OPERACION;
  private equipoSubject = new BehaviorSubject<PlanillaOperacion[]>([]);
  ...
  */
   ...
   */
  connect(collectionViewer: CollectionViewer): Observable<PlanillaOperacion[]> {
 ...
 /**
   ...
   */
  loadData(criteria: PlanillaOperacionCriteria): void {
  ...
  loadData_children(criteria: PlanillaOperacionCriteria): void {
    this.loadingSubject.next(true);
