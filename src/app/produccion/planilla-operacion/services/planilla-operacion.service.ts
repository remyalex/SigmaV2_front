...
export class PlanillaOperacionService {
  ...
  */
    ...
    this.resourceUrl = appSettings.settings.hostApi + this.constants.path_produccion_planilla_operacion_consulta;
   }
   ...
   */
  search(criteria: PlanillaOperacionCriteria): Observable<CollectionResponse<PlanillaOperacion>> {
    return this.http.get<CollectionResponse<PlanillaOperacion>>(this.resourceUrl + '/search?' + criteria.getUrlParameters());
  }
   ...
   */
  list (): Observable<PlanillaOperacion[]> {
    return this.http.get<PlanillaOperacion[]>(this.resourceUrl);
  }
   ...
   */
  create (equipo: PlanillaOperacion): Observable<PlanillaOperacion> {
    return this.http.post<PlanillaOperacion>(this.resourceUrl, equipo, httpOptions );
  }
  ...
  */
  update (equipo: PlanillaOperacion): Observable<PlanillaOperacion> {
    return this.http.put<PlanillaOperacion>(this.resourceUrl, equipo, httpOptions );
  }
   ...
   * registro que se va a actualizar
   */
  detail (equipoId: number): Observable<PlanillaOperacion> {
    return this.http.get<PlanillaOperacion>(this.resourceUrl + '/' + equipoId);
  }
  ...
  * registro que se va a actualizar
  */
  delete (equipoId: number): Observable<PlanillaOperacion> {
    return this.http.delete<PlanillaOperacion>(this.resourceUrl + '/' + equipoId);
  }
