...
export class FormulaMezclaLaboratorioService {
  ...
  */
    ...
    this.resourceUrl = appSettings.settings.hostApi + this.constants.path_produccion_registrar_formulas;
   }
   ...
   */
  search(criteria: FormulaCriteria): Observable<CollectionResponse<Formula>> {
    return this.http.get<CollectionResponse<Formula>>(this.resourceUrl + '/search?' + criteria.getUrlParameters());
  }
  ...
  */
  ...
  ultimaFormulaVigente(tipoMezclaId: number): Observable<Formula> {
    return this.http.get<Formula>(this.resourceUrl + '/ultimaFormulaVigente/' + tipoMezclaId);
  }
