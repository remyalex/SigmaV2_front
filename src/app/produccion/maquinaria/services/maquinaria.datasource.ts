 ...
 **/
export class MaquinariaDatasource implements DataSource<Maquinaria> {
 /** Constantes a usar en el componente */
  constants = CONST_PRODUCCION_MAQUINARIA;
  private equipoSubject = new BehaviorSubject<Maquinaria[]>([]);
  ...
  */
  constructor (private servicio: MaquinariaService) { }
   ...
   */
  connect(collectionViewer: CollectionViewer): Observable<Maquinaria[]> {
 ...
 /**
   ...
   */
  loadData(criteria: MaquinariaCriteria, callback?: (result, error) => void): void {
