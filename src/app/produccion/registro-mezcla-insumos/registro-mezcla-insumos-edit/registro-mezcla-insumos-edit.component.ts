...
import { SolicitudMezclaInsumos, RegistrarVale, EditarVale} from '../models/registro-mezcla-insumos.model';
...
@Component({
  ...
  selector: 'sigma-produccion-registro-mezcla-insumos-edit',
  templateUrl: './registro-mezcla-insumos-edit.component.html',
  providers: [
...
export class RegistroMezclaInsumosEditComponent implements OnInit {
 /** Constantes a usar en el componente */
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<RegistroMezclaInsumosEditComponent>,
    private formBuilder: FormBuilder,
    @Inject(MAT_DIALOG_DATA) data: EditarVale,
    ...
    this.registroVale = this.datosComplete;
    this.form.get('numeroVale').disable();
    this.form.get('numeroMovil').disable();
    this.registroVale.tipoVale =  { id: this.datosComplete.idTipoVale ? this.datosComplete.idTipoVale : '', valor: '', descripcion: '', activo: true};
    this.registroVale.planta = { id: this.datosComplete.idPlanta ? this.datosComplete.idPlanta : '', valor: '', descripcion: '', activo: true};
    this.registroVale.conductor = { id: this.datosComplete.idPersona ? this.datosComplete.idPersona : '', valor: '', descripcion: '', activo: true};
    this.registroVale.formula = { id: this.datosComplete.idFormula ? this.datosComplete.idFormula : '', valor: '', descripcion: '', activo: true};
    this.registroVale.jefeBascula = { id: this.datosComplete.idJefeBascula ? this.datosComplete.idJefeBascula : '', valor: '', descripcion: '', activo: true};
    this.registroVale.numeroMovil = this.datosComplete.movil;
  ...
  this.datasend = [];
      let array = 
      {
        idSolicitudMezclaDetalle:  this.datosComplete.idSolicitudMezclaDetalle,
        activo: true,
        ...
        idTipoMaterial: this.datosComplete.idTipoMaterial,
        tipoMaterial: this.datosComplete.material ? this.datosComplete.material : '',
        idEquipo:  this.datosComplete.idEquipo,
        equipo: this.datosComplete.equipo ? this.datosComplete.equipo : '',
        idPersona: this.registroVale.conductor.id,
        conductor: this.registroVale.conductor.descripcion,
        idFormula:  this.registroVale.idFormula,
        civ: this.datosComplete.civ,
        idBarrio: this.datosComplete.idBarrio,
        barrio: this.datosComplete.barrio ? this.datosComplete.barrio : '',
        idLocalidad: this.datosComplete.idLocalidad,
        numeroMovil: Number(this.registroVale.numeroMovil),
        localidad: this.datosComplete.localidad ? this.datosComplete.localidad : '',
        formula: this.registroVale.formula.descripcion,
        idDetalleVale: this.datosComplete.idDetalleVale,
        id:this.datosComplete.id,
        idVale:this.datosComplete.idVale
      }

    this.datasend.push(array);  
  
   this.disableSubmit = true;
    this.servicio.update(this.datasend).subscribe(data => {
      this.enviada = false;
