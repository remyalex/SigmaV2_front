...
@Component({
  selector: 'sigma-produccion-tarjeta-operacion-admin',
  templateUrl: './tarjeta-operacion-admin.component.html'
})

export class TarjetaOperacionAdminComponent implements OnInit {
