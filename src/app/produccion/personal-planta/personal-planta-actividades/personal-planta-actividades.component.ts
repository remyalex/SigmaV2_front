...
import { Actividades} from '../models/personal-planta.model';
...
@Component({
  ...
  selector: 'sigma-produccion-personal-planta-actividades',
  templateUrl: './personal-planta-actividades.component.html',
  providers: [
...
export class PersonalPlantaActividadesComponent implements OnInit {
  ...
  */
  constructor(
    ...
    private dialogRef: MatDialogRef<PersonalPlantaActividadesComponent>,
  ...
  save() {
    this.dialogRef.close(this.form_actividades.value);
