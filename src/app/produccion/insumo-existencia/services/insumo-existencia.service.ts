...
export class InsumoExistenciaService {
  ...
  */
    ...
    this.resourceUrl = appSettings.settings.hostApi + this.constants.path_produccion_insumo_existencia;
   }
   ...
   */
  search(criteria: InsumoExistenciaCriteria): Observable<CollectionResponse<InsumoExistencia>> {
    return this.http.get<CollectionResponse<InsumoExistencia>>(this.resourceUrl + 'search?' + criteria.getUrlParameters());
  }
   ...
   */
  list (): Observable<InsumoExistencia[]> {
    return this.http.get<InsumoExistencia[]>(this.resourceUrl);
  }
   ...
   */
  create (formato: InsumoExistencia): Observable<InsumoExistencia> {
    return this.http.post<InsumoExistencia>(this.resourceUrl, formato, httpOptions );
  }
  ...
  */
  update (formato: InsumoExistencia): Observable<InsumoExistencia> {
    return this.http.put<InsumoExistencia>(this.resourceUrl, formato, httpOptions );
  }
   ...
   * registro que se va a actualizar
   */
  detail (formatoId: number): Observable<InsumoExistencia> {
    return this.http.get<InsumoExistencia>(this.resourceUrl + formatoId);
  }
  ...
  * registro que se va a actualizar
  */
  delete (formatoId: number): Observable<InsumoExistencia> {
    return this.http.delete<InsumoExistencia>(this.resourceUrl + formatoId);
  }
  updateDataInsumoExistencia(data) {
