 ...
 **/
export class HistorialMantenimientoDatasource implements DataSource<HistorialMantenimientoModel> {

    public diagnosticosHistorialSubject = new BehaviorSubject<HistorialMantenimientoModel[]>([]);
    ...
    public diagnosticosHistorialData: any;
   ...
   */
  connect(collectionViewer: CollectionViewer): Observable<HistorialMantenimientoModel[]> {
        return this.diagnosticosHistorialSubject.asObservable();
    }
  ...
  disconnect(collectionViewer: CollectionViewer): void {
        this.diagnosticosHistorialSubject.complete();
  ...
  loadData(criteria: HistorialMantenimientoCriteria, busquedaAvanzada: boolean): void {
    ...
    handlerSuccessfulResponse(data: any) {
        this.historialData = data.content;
        this.diagnosticosHistorialSubject.next(data.content);
    ...
    handlerFailedResponse() {
        this.historialData = [];
        this.diagnosticosHistorialSubject.next([]);
